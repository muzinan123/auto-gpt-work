...
class PythonCodeParser(BaseOutputParser):
    """Extract Python code from the text returned by OpenAI."""
...
class ExcelAnalyser:
    ...
    def analyse(self, query, filename):
        ...
        """Analyze the content of a structured file (e.g., Excel file)."""
...
if __name__ == "__main__":
    print(ExcelAnalyser().analyse(
        query="August sales",
        filename="../data/2023 August-September Sales Record.xlsx"
    ))
